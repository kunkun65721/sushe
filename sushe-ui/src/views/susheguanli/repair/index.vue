<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['susheguanli:repair:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['susheguanli:repair:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['susheguanli:repair:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['susheguanli:repair:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="repairList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="报修学生ID" align="center" prop="studentId" />
      ...
      <el-table-column label="报修图片" align="center" prop="images" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="报修学生ID" prop="studentId">
              <el-input v-model="form.studentId" placeholder="请输入报修学生ID" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
...
<script>
import { listRepair, getRepair, delRepair, addRepair, updateRepair } from "@/api/susheguanli/repair"
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        studentId: [
          { required: true, message: "报修学生ID不能为空", trigger: "blur" }
        ],
        repairType: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除报修记录编号为"' + repairIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('susheguanli/repair/export', {
        ...this.queryParams
